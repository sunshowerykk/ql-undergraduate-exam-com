                                        ...
                                        <?elseif ($q['type']==3 || $q['type']==4):?>
                                            <li <?if($q['questioncap']<>'1'):?>class="paperexamcontent"<?endif;?> id="qu_<?=$q['questionid']?>">
                                                ...
                                                <?if($q['questioncap']<>'1'):?>
                                                    ...
                                                    <br/><span>评分：<input  type="text" id="question<?=$q['questionid']?>" data-chk='<?=$v['typenum']?>、<?=$v['typename']?>第<?=$q['RowNum']?>题评分' class="c-set" onblur="sroce(<?=$q['questionid']?>,<?=$q['questionscore']?>);" name="vScore[<?=$q['questionid']?>]" >
                                                    ...
                                                    <ul>
                                                        <?foreach ($q['capquestion'] as $c):?>
                                                            <li class="paperexamcontent" id="qu_<?=$c['questionid']?>">
                                                                ...
                                                                <br/><span>评分：<input  type="text" id="question<?=$c['questionid']?>" class="c-set" data-chk='<?=$v['typenum']?>、<?=$v['typename']?>第<?=$q['RowNum']?>小题评分'  onblur="sroce(<?=$c['questionid']?>,<?=$c['questionscore']?>);" name="vScore[<?=$c['questionid']?>]" />
...
<script type="text/javascript">
    ...
    function endsave() {
        var msg=fieldsCheck.checkMsg('#'+'dialogForm');
