...
<div class="contentTwo" style="overflow:auto">
        ...
        <div class="anHeadCon">
            ...
            <div class="anHeadRight">
                <ul class="anHeadRightB">
                    <li class="anBlast" onclick="artSave('dialogForm')">保存提交阅卷</li>
                </ul>
    ...
    <div class="anTab">
        ...
        <!--选项卡-->
        <form action="?r=student/myexam/savehead" method="post" id="dialogForm" >
                                                ...
                                                <li <?if($q['questioncap']<>'1'):?>class="paperexamcontent"<?endif;?> id="qu_<?=$q['questionid']?>">
                                                    ...
                                                    <?if($q['questioncap']<>'1'):?>
                                                        ...
                                                        <?if(!empty($q['questionvideo'])):?>
                                                            <br/><span><span><a href="<?=$q['questionvideo']?>" target="view_window">视频讲解</a></span></span>
                                                        <?endif;?>
                                                    <?endif;?>
                                        ...
                                        <?elseif ($q['type']==3 || $q['type']==4):?>
                                                <li <?if($q['questioncap']<>'1'):?>class="paperexamcontent"<?endif;?> id="qu_<?=$q['questionid']?>">
                                                    ...
                                                    <?if($q['questioncap']<>'1'):?>
                                                        ...
                                                        <br/><span>评分：<input  type="text" id="question<?=$q['questionid']?>" class="c-i" onblur="sroce(<?=$q['questionid']?>,<?=$q['questionscore']?>);" name="vScore[<?=$q['questionid']?>]" >
                                                 <input type="hidden" id="vErrors<?=$q['questionid']?>" name="vErrors[<?=$q['questionid']?>]" value='<?=$q['u_answer']?>'></span>
                                                        <br/><span>评语：<input type="text" name="vComment[<?=$q['questionid']?>]" placeholder="在此输入评语"></span>
                                                        <?if(!empty($q['questionvideo'])):?>
                                                            <br/><span><span><a href="javascript:void(0)" data-url="<?=$q['questionvideo']?>" class="vedioPlay">视频讲解</a></span></span>
                                                        <?endif;?>
                                                    <?endif;?>
                                                        ...
                                                        <ul>
                                                            <?foreach ($q['capquestion'] as $c):?>
                                                                <li class="paperexamcontent" id="qu_<?=$c['questionid']?>">
                                                                    ...
                                                                    <br/><span>评分：<input  type="text" id="question<?=$c['questionid']?>" class="c-i" onblur="sroce(<?=$c['questionid']?>,<?=$c['questionscore']?>);" name="vScore[<?=$c['questionid']?>]" />
                                                                    <input type="hidden" id="vErrors<?=$c['questionid']?>" name="vErrors[<?=$c['questionid']?>]" value='<?=$c['u_answer']?>' /></span>
                                                                    <br/><span>评语：<input type="text" name="vComment[<?=$c['questionid']?>]" placeholder="在此输入评语"></span>
                                                                    <?if(!empty($c['questionvideo'])):?>
                                                                        <br/><span><span><a href="javascript:void(0)" data-url="<?=$q['questionvideo']?>" class="vedioPlay">视频讲解</a></span></span>
                                                                    <?endif;?>
                                                                </li>
...
<div class="anTs">
    <div class="anJChaCen">
        ...
        <div class="anJcCen">
            ...
            <div class="anJcBtn">
                <div class="anJcBtnB anTsBtn" ><a href="?r=student/myexam">查看答卷</a></div>
            </div>
        </div>
    </div>
</div>
